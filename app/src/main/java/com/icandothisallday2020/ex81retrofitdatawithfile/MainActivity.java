...
public class MainActivity extends AppCompatActivity {
    ...
    public void uploadBtn(View view) {
        ...
        //서버에 보낼 이미지파일을 MultiPartBody.Part 객체로 생성
        File file=new File(imgPath);
        RequestBody requestBody=RequestBody.create(MediaType.parse("image/*"),file);
        MultipartBody.Part filePart=MultipartBody.Part.createFormData("img",file.getName(),requestBody);//식별자,파일명, 요청객체

        //서버에 보낼 나머지 데이터들을 Map Collection 으로
